...
# Princípios Orientadores clean-code-javascript

## Índice
  1. [Variáveis](#variáveis)
  2. [Funções](#funções)
  3. [Objetos e Estruturas de Dados](#objetos-e-estruturas-de-dados)
  4. [Classes](#classes)
  5. [SOLID](#solid)
  6. [Testes](#testes)
...
Duas ressalvas desta abordagem:
  ...
  2. Clonar objetos grandes pode ser bastante caro em termos de desempenho.
...
## **Testes**
Testes são mais importantes que entregas. Se você não possui testes ou um quantidade inadequada, então toda vez que você entregar seu código você não terá certeza se você não quebrou alguma coisa.
